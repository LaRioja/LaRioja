            ...
            <div class="row">
                <form class="form-horizontal" name="ajusticia" id="ajusticia" action="AnadirRegistroPalacioJusticia" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="sala" id="sala" placeholder="Número de sala" value="<c:out value="${sala}"/>" required="true" autofocus="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputProcedimiento" class="col-sm-3 control-label">Procedimiento *</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="procedimiento" id="procedimiento" placeholder="Procedimiento" value="<c:out value="${procedimiento}"/>" required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputDescripcion" class="col-sm-3 control-label">Descripción *</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="descripcion" id="descripcion" placeholder="Descripción" value="<c:out value="${descripcion}"/>" required="true">
                        </div>
                    </div>
                    <div class="form-group">
