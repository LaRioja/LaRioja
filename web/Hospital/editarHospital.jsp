                    ...
                    <div class="row">
                        <form class="form-horizontal" name="hospital" id="fhospital" action="ModificarRegistroHospital" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre" value="${hospital.nombremedico!=null ? hospital.nombremedico : nombre}" required="true" autofocus="true" maxlength="50">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputApellidos" class="col-sm-3 control-label">Apellidos *</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="apellidos" id="apellidos" placeholder="Apellidos" value="${hospital.apellidomedico!=null ? hospital.apellidomedico : apellidos}" required="true" maxlength="80">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputConsulta" class="col-sm-3 control-label">Número consulta *</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="consulta" id="consulta" placeholder="Número consulta" value="${hospital.numeroconsulta!=null ? hospital.numeroconsulta : consulta}" required="true" maxlength="6">
                                </div>
                            </div>
                            <div class="form-group">
